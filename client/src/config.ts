 ...
 * Para XAMPP con Apache, la URL debería ser: http://localhost/tfg/server/public/api/v1
 * O si configuras un VirtualHost: http://lol-gg.local/api/v1
 */
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost/tfg/server/public/api/v1';
